...
pub enum UpdateAction {
    /// Update via `npm install -g @sirvkrm/codex-cli-termux@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @sirvkrm/codex-cli-termux@latest`.
    BunGlobalLatest,
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::NpmGlobalLatest => (
                "npm",
                &["install", "-g", "@sirvkrm/codex-cli-termux@latest"],
            ),
